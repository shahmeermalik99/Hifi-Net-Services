                    ...
                    <div class="static-table-list">
                        <div class="basic-login-inner">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered-less  table-responsive py-4">
                                    <thead>
                                    </thead>
                                    <tbody>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <div class="col-sm-9">
                                            <input type="hidden" class="form-control" value="{{ $client->latitude }}"
                                                placeholder="latitude" name="latitude" id="lat">
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="hidden" class="form-control" value="{{ $client->longitude }}"
                                                placeholder="longitude" name="longitude" id="lng">
                                        </div>
                                    </tfoot>
                                </table>
                                <center>
                                ...
                                <div>
                                    <br>
                                    {{-- <a class="btn btn-sm btn-primary" href="{{ route('clients.clientlist') }}">Back</a> --}}
                                </div>
                            </div>
                        </div>
                    </div>
