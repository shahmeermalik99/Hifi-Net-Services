                    ...
                    <form action="{{ route('reports.customers') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <a href="{{ route('reports.customers') }}" type="button" style="margin-top:5%;margin-top:22px" value="Search" class=" btn btn-sm btn-warning"><i class="bi bi-arrow-clockwise"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
