        ...
        <div class="sparkline9-list mt-b-30">
            <div class="sparkline9-hd">
                <div class="main-sparkline9-hd">
                    <a href="{{route('expenses.addexpense')}}" type="button" id="button" class="btn btn-primary pb-2" style="float: right;">Add Expense</a>
                </div>
                <br>
                <br>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr style="padding: 1px;">
                                    ...
                                    <td style="width: 5%;padding: 1px;">
                                        <a type="button" href="{{url('updateexpense', $list->id)}}" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
                                        <a type="button" href="{{url('showexpense', $list->id)}}" class="btn btn-warning mx-2 py-2 inline"><i class="bi bi-eye-fill"></i></a>
                                        <form method="POST" action="{{url('destroy4', $list->id)}}" style="display:inline-block">
                                            @csrf
